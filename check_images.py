...
def main():
    ...
    # and creates the results dictionary that contains the results.
    # Dictionary is returned from the function call as the variable results
    ...
    # Function checking Results Statistics Dictionary using results_stats
