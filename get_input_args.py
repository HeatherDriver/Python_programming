...
def get_input_args():
    """
    Retrieves and parses the 3 command line arguments provided when
    they run the program from a terminal window. This function uses Python's 
    argparse module and if the user fails to provide some or all of the 3 arguments, 
    ...
    """
    # Creates Parser using ArgumentParser
